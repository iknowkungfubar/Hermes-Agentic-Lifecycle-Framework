...
class TestNodesAll:
    ...
    def test_all_phases_import(self):
        from half.runtime.nodes import (
            phase_1_discovery, phase_1_specification, phase_1_architecture, phase_1_gate,
            phase_2_scaffold, phase_2_research, phase_2_plan, phase_2_implement,
            phase_2_simplify, phase_2_gate,
            phase_3_testing, phase_3_security, phase_3_integration, phase_3_gate,
            phase_4_infrastructure, phase_4_cicd, phase_4_launch, phase_4_gate,
            phase_5_observe, phase_5_iterate, phase_5_codify, phase_5_gate,
            route_from_gate, _write_artifact
        )
    ...
    def test_phase_4_chain(self):
        from half.runtime.nodes import phase_4_infrastructure, phase_4_cicd, phase_4_launch, phase_4_gate
        s = {"messages": []}
    ...
    def test_phase_5_chain(self):
        from half.runtime.nodes import phase_5_observe, phase_5_iterate, phase_5_codify, phase_5_gate
        s = {"messages": []}
    ...
    def test_route_from_gate(self):
        ...
        r = route_from_gate({"gate_1_passed": True, "phase_1_complete": True, "messages": []})
...
class TestEvalsFull:
    def test_evaluate_from_log(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            log.write_text("INFO: 100 tokens consumed\\nERROR: test failed\\n```\\ncode here\\n```\\n")
