...
class TestEverythingInProcess:
    ...
    def test_half_sidecar(self):
        from half.half_sidecar import (
            ...
            cmd_generate_mrp, cmd_voice_stt, cmd_voice_tts
        )
    ...
    def test_self_correct(self):
        ...
        rpt = sc.analyze_failure(stderr="""File "test.py", line 10, in foo\n    assert False\nAssertionError""")
    ...
    def test_rlvmr(self):
        ...
        tag = tr.tag_step("r1", CognitiveStep.PLANNING, "plan", token_cost=10, success=True)
